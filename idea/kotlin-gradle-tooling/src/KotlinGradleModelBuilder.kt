...
abstract class AbstractKotlinGradleModelBuilder : ModelBuilderService {
    companion object {
        val kotlinCompileTaskClasses =
                listOf("KotlinCompile", "Kotlin2JsCompile", "KotlinCompileCommon").flatMap { taskClassName ->
                    listOf("", "Cacheable").map { cacheablePrefix ->
                        "org.jetbrains.kotlin.gradle.tasks.$cacheablePrefix${taskClassName}_Decorated"
                    }
                }
